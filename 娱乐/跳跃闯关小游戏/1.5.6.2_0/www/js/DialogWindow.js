	...
	function DialogWindow() {
        ...
        this.tick = function (delta) {
            ...
            if (this.dialog != null){
                if (this.dialog.state == "pause"){ //pause screen
                    ...
                    for (var i=0; i < this.skins.children.length; i++){
                        if (this.skins.getChildAt(i).isClicked()){
                            window.storageManager.setSkin(i);
                ...
                else if (this.dialog.state == "shareOptions"){ //upload successful
                    if (this.button_back.isClicked()){ this.removeDialogWindow(); }
        ...
        this.createDialogWindow = function(state){
            ...
            if (state == "pause"){ //menu dialog
                this.text_1.text = "Custom skins";
                this.text_2.text = "";
                if (window.storageManager.hasLicense() == false) this.text_2.text = "(Upgrade to Pro)";
                this.text_1.y += this.box * 4;
                this.text_2.y += this.box * 3.5;
                ...
                this.text_1.text = "Download Options";
            ...
            else if (state == "shareOptions"){  //play code
                this.text_1.text = "Share Options";
        ...
        this.addSkinOptions = function(){
            ...
            for (var i=0; i < options; i++) {
                var button = new Button("" + (i + 1), ((this.box * 8) * ((i+1) / options)) + (this.box * 3), (this.height * 0.4), this.box*2, this.box*2, "#000000", this.main_color3, "#ffffff", "#ffffff");
                button.setFontSize(0.75);
                if (i == skin) button.toggleColor(true);
                if (hasLicense == false && i != 0) button.disable(0.25);
